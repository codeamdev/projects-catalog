      ...
      <footer className="mt-10 border-t border-gray-100 bg-gray-50 py-10">
        <div className="max-w-screen-xl mx-auto px-4 text-center space-y-4">
          ...
          {(s?.instagramUrl || s?.facebookUrl || s?.tiktokUrl || s?.youtubeUrl) && (
            <div>
              <p className="text-sm font-semibold text-gray-700 mb-3">Visitá nuestras redes sociales</p>
              <div className="flex items-center justify-center gap-4">
                {s?.instagramUrl && (
                  <a href={s.instagramUrl} target="_blank" rel="noopener noreferrer"
                    className="flex items-center gap-1.5 text-gray-500 hover:text-pink-500 transition-colors text-sm font-medium">
