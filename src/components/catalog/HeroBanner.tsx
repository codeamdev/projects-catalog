    ...
    >
      ...
      {videoUrl && (
        <button
          ...
          className="absolute bottom-7 right-5 z-10 flex items-center justify-center w-9 h-9 rounded-full bg-black/40 hover:bg-black/60 text-white transition-colors"
        >
